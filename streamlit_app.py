...
# -------------------------------
# 2) Connect to Qdrant (Cloud/Hosted)
# -------------------------------
# Replace <YOUR_QDRANT_CLOUD_URL> with your hosted Qdrant instance
client = QdrantClient(url="<YOUR_QDRANT_CLOUD_URL>")  
...
st.info("Model: MiniLM-L6-v2 • Vector DB: Qdrant (Cloud)")
